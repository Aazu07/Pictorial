...
class ImagesAdapter(private val context: Context, private val list: ArrayList<ImageFromStorage>) :
    ...
    inner class ImageViewHolder(private val itemBinding: ItemImageRecyclerviewBinding) :
        ...
        fun onBind() {
//            val size = getSize(list[adapterPosition])
            itemBinding.image.layoutParams = ConstraintLayout.LayoutParams(
                (screenWidth / 2),
...
//
//            Log.d("ORIGINAL", "original width ${imageFromStorage.width} height ${imageFromStorage.height}")
//
